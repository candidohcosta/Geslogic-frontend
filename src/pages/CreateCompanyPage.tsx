// frontend/src/pages/CreateCompanyPage.tsx
...
const CreateCompanyPage: React.FC<CreateCompanyPageProps> = ({ user, onBack }) => {
  return (
    <div className="p-6 max-w-2xl mx-auto bg-white rounded-xl shadow-md space-y-4 text-gray-800 flex-grow flex flex-col justify-center">
      <h2 className="text-2xl font-bold text-center mb-4">Criar Nova Empresa</h2>
      <p className="text-center text-lg">Esta é a página para criar uma nova empresa.</p>
